...
<form action="pro_update.php?id=<?php echo $id;?>" method="POST">
	...
	Description:<br/><textarea class="w3-input w3-border w3-round-large" name="description" value="<?php echo $result['description']; ?>"/><?php echo $result['description']; ?></textarea><br/><br/>
	...
	Category:<select class="w3-select w3-border" name="category">
		<option value="<?php echo $cview['id'];?>"><?php echo $result['category_name'];?></option>
	<?php
